class FormulaEngine {
  constructor(dailyTarget, config) {
  ...
  distributeMacros(
    mealCount,
    periWorkoutIndices = [] // 0-based indices of peri-workout meals
  ) {
    ...
    let carbDistribution = new Array(mealCount).fill(0);
    let fatDistribution = new Array(mealCount).fill(0);
