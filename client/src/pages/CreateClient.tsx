    ...
    return (
        <div className="min-h-screen bg-background p-8 relative">
            <div className="max-w-md mx-auto bg-surface p-8 rounded-lg shadow-glow border border-border">
                <h2 className="text-3xl font-bold text-center text-highlight mb-6">Create New Client</h2>

                {error && <div className="bg-critical/20 border border-critical text-highlight px-4 py-2 rounded mb-4 text-center">{error}</div>}
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium text-highlight">
                            Client Name
                        </label>
                        <input
                            type="text"
                ...
                <div className="mt-6 text-center">
                    <button onClick={() => navigate("/admin/clients")} className="text-sm text-muted hover:text-white transition-colors">
